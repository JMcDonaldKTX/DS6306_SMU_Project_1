...
#make all IPA's have Style of IPA and all ales have simply ale - eliminates all of the additional types to act on them as all the same
...
#run 25 iterations to test the best value of K to test the best accuracy
